        ...
        if response.rows:
            ...
            if target_col:
                ...
                # If it's a string already
                    ...
                    print(f"[DEBUG] Already a string: {response_text[:100]}...")
                ...
                # Other attribute-based objects
                    ...
                    print(f"[DEBUG] Extracted from .text: {response_text[:100]}...")
                elif hasattr(target_col, "value"):
                    response_text = str(target_col.value)
                    print(f"[DEBUG] Extracted from .value: {response_text[:100]}...")
                elif hasattr(target_col, "content"):
                    response_text = str(target_col.content)
                    print(f"[DEBUG] Extracted from .content: {response_text[:100]}...")
                
                else:
                    print(f"[DEBUG] Unknown structure, converting to string")
